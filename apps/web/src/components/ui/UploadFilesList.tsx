                ...
                (file, index: number) => (
                  ...
                  >
                    <div className="flex gap-2 items-center">
                      ...
                      <div>
                        ...
                        <span className="block text-sm text-gray-500">
                          ...
                          MB .{' '}
                          <span className="pl-0.3">
                            {uploads &&
                            uploads[file.fileId]
                              ?.progress === 100
                              ? 'Uploaded'
                              : `${(uploads && uploads[file.fileId]?.progress) || 0}%`}
                          </span>
                        </span>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      <div
                        className={`${uploads && uploads[file.fileId]?.progress > 0 ? 'block' : 'hidden'}`}
                      >
                        {uploads &&
                        uploads[file.fileId]
                          ?.status === 'saved' ? (
                          ...
                          <Loader2
                            size={20}
                            className="animate-spin text-sm rounded-full"
                          />
                        )}
                      </div>
                      <X
